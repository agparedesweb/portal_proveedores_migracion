...
if(isset($_POST['buscar'])){
	...
	$desde=$_POST['desde'];
	$hasta=$_POST['hasta'];	
	$query=mysql_query("SELECT reg.folio_interno,reg.folio_uuid, reg.nombre_xml, date(reg.fecha),reg.orden_compra, reg.valido,reg.errores FROM records_xml as reg inner join users as usu on reg.rfc =usu.id WHERE date(reg.fecha) BETWEEN '".$desde."' AND '".$hasta."' AND reg.rfc='".$rfc."'");
...
<body>			       
    ...
    <div class="main">  
    	<div class="wrap"> 
    		<div class="column_left">
    			<form action="consulta_intfact.php" method="post">
    				<h2>Buscador</h2>
	...
	<div>
        <center class="imgFooter"><a href="http://www.aparedes.com.mx" target="blank"><img style="width:15%" src="img/chiles.gif" alt="Agricola Paredes SA DE CV"/></a></center>
	</div>
