                        ...
                        {   
                            foreach ($fol as $folio){
                                ...
                                for ($n=0; $n <= count($mftos)-1; $n++) { 
                                    ...
                                    $upd = "UPDATE eye_maniffacturados SET CRELACIONADO='S' WHERE CFOLIO_REMIS='".substr($sel,-8)."'";
