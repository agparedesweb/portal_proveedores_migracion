...
@$msg=$_GET["msg"];
if($msg==1){
	$msgtxt="<center><div class='tool_tip'><ul class='tt-wrapper'><li><a class='tt-sample' href='#''><img src='img/ok.png' alt=''/><span>Formulario enviado con exito!</span></a></li></ul></div></center>";
}
